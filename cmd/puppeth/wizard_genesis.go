...
func (w *wizard) manageGenesis() {
	...
	case "1":
		...
		fmt.Println()
		fmt.Printf("Which block should Paris come into effect? (default = %v)\n", w.conf.Genesis.Config.ParisBlock)
		w.conf.Genesis.Config.ParisBlock = w.readDefaultBigInt(w.conf.Genesis.Config.ParisBlock)
